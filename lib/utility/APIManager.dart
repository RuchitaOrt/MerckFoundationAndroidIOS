...
apiPathString =
            "digital_library/merck-foundation-nationwide-diabetes-and-hypertension-blue-points-program/1";
        break;
  ...
  dynamic parseResponse(String className, var json) {
    ...
    if (className == "GetEpisodeSeasonwiseResponse") {
      //enterhere
