...
class PhotoGalleryPage extends StatefulWidget {
  ...
  PhotoGalleryPage({Key? key, required this.photosList, this.index, this.baseURL, this.appBarTitle})
      : super(key: key);
...
class _PhotoGalleryPageState extends State<PhotoGalleryPage> {
      ...
      body: ListView(
        ...
        children: [
          GridView.count(
            ...
            children: widget.photosList.map<Widget>((photo) {
              if (widget.index == 0) {
                return photoWidget(
  ...
  void getphotodetail(String categoryID) async {
      ...
      APIManager().apiRequest(
        ...
        (response) async {
          ...
          if (resp.success!.toLowerCase() == "true") {
            ...
            ShowDialogs.showToast(resp.msg ?? "Unknown error occurred.");
          }
        },
        (error) {
          Navigator.of(_keyLoader.currentContext!).pop();
          ShowDialogs.showToast("Something went wrong: $error");
        },
        jsonval: json,
      );
    } else {
