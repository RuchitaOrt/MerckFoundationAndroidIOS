...
//   // ///share to linkedin
//   Future<String> shareToLinkedin({​String msg = '', String url = ''}​) async {​
//     final Map<String, Object> arguments = Map<String, dynamic>();
//     arguments.putIfAbsent('msg', () => msg);
//     arguments.putIfAbsent('url', () => url);
//     dynamic result;
//     try {​
//       result = await _channel.invokeMethod('shareLinkedin', arguments);
//     }​ catch (e) {​
//       return "false";
//     }​
//     return result;
...
//   // ///share to linkedin
//   Future<String> openinsta({​String msg = '', String url = ''}​) async {​
//     final Map<String, Object> arguments = Map<String, dynamic>();
//     arguments.putIfAbsent('msg', () => msg);
//     arguments.putIfAbsent('url', () => url);
//     dynamic result;
//     try {​
//       result = await _channel.invokeMethod('openinsta', arguments);
//     }​ catch (e) {​
//       return "false";
//     }​
//     return result;
