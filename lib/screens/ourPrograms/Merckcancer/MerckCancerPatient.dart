...
import 'package:merckfoundation22dec/model/merckcancerpatient.dart';
...
class MerckCancerPatient extends StatefulWidget {
  @override
...
class OurProgramsDetailsState extends State<MerckCancerPatient>
  ...
  Future<http.Response> getmmtmapi() async {
    ...
    if (status1) {
      var response = await APIManager.fetchget(
        encoding: APIManager.subprocancerpatient,
      );
      print("response");
      print(response);
