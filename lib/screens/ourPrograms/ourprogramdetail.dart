...
final GlobalKey<CustomAdvFabState> fabKey = GlobalKey<CustomAdvFabState>();
  ...
  //     OurProgramDetails(),                         // 0
  //     MerckCanceraccess(),                         // 1
  //     ourProgramdetailsforcapacityAdv(),           // 2
  //     Container(),                                 // 3 (no widget defined for 3)
  //     Merckstemprogram(),                          // 4
  //     EmpoweringBerna(),                           // 5
  //     LocalSongsandChildrenStories(),              // 6
  //     WatchmoreVideolibrary(                       // 7
  //       apiurl: API.watchvideommtm,
  //       headertitle: 'Merck Foundation "More Than A Mother" Movement Videos',
  //       sharelink: Constantstring.sharewatchallvideovideommtm,
  //     ),
  //     AboutMerckMother(),                          // 8
  //     StrategyDetails(),                           // 9
  //     MotherAmbassadarDetails(),                   // 10
  //     MerckFertility(),                            // 11
  //     FirstLadiesInitiativeDetails(),              // 12
  //     ourProgramdetailsforhypertensionbluepoint(), // 13
  //     EducatingLinda(),                            // 14
  //     CommunityAwareness(),                        // 15
  //     OurProgramMotherScollership(),               // 16
  //   ],
  // ),
        // AdvFabBottomBarBody(
        //   screens: <Widget>[
