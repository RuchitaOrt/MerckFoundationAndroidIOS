...
class OurProgramMotherScollership extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return OurProgramMotherScollershipState();
  }
}

class OurProgramMotherScollershipState
    extends State<OurProgramMotherScollership> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: InnerCustomAppBar(
        ...
        title:
            'Merck Foundation More Than a Mother Scholarships', //"About Merck Foundation More Than A Mother",
  ...
  Future<http.Response?> getmmtmapi() async {
    ...
    if (status1) {
      var response = await APIManager.fetchget(
        encoding: APIManager.submotherscollership,
      );
      print("response");
      print(response);
