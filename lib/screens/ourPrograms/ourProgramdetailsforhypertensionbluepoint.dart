...
class ourProgramdetailsforhypertensionbluepoint extends StatefulWidget {
...
class _MyHomePageState
    extends State<ourProgramdetailsforhypertensionbluepoint> {
  final int indexpass;
...
//                                                   ),
  ...
  gethypertensionprogramlist() async {
    var status1 = await ConnectionDetector.checkInternetConnection();
  ...
  getsteminnerapi(String menuurl) async {
    ...
    if (status) {
      ...
      //         context,
      //         MaterialPageRoute(
      //             builder: (BuildContext context) => ourProgramdetailsforhypertensionbluepoint(
      //                   indexpass: 2,
...
// class _MyHomePageState extends State<ourProgramdetailsforhypertensionbluepoint> {
//   final int indexpass;
//   AdvFabController mabialaFABController;
