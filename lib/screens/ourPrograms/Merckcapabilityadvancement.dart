                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      Platform.isAndroid
                          ? ShowDialogs.followuslink(
                              Constantstring.followmmerckAdvancementyoutube,
                              Constantstring.followmsg)
                          : ShowDialogs.youtubevideolink(
                              Constantstring.followmmerckAdvancementyoutube);
                    },
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (BuildContext context) => GalleryProgram(
                              apiurl: API.programgallerycapacity,
                            )));
              },
 ...
 "tr": Customcolor.tableboderstyle(),
        ...
        listofwiget.add(
          Padding(
            ...
            child: CustomHorizontalCard(
              ...
              btnTitle: "View More",
              titleImg: "assets/newImages/flowers-3.png",
              heigthoflist: SizeConfig.blockSizeVertical * 47,
              list: ListView.builder(
  ...
  getprogramgallery() async {
    ...
    if (status1) {
      ...
      APIManager().apiRequest(context, API.programgallerycapacity,
          (response) async {
