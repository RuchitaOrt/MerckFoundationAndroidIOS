...
final GlobalKey<CustomAdvFabState> fabKey = GlobalKey<CustomAdvFabState>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: GlobalLists.awardsubtypelisting.isNotEmpty
    ? Padding(
        ...
        CustomAdvFab(
          ...
          expandedContent: ListView.builder(
            ...
            shrinkWrap: true,
            itemCount: GlobalLists.awardsubtypelisting.length,
            itemBuilder: (context, index) {
              final award = GlobalLists.awardsubtypelisting[index];
             return Column(
  ...
  children: [
     Padding(
       ...
       child: GestureDetector(
          ...
          child: 
          // Text("Awards ${award.year}",style: TextStyle(),)
          FormLabel(
                                                              text:
     ...
     const Divider(color: Customcolor.text_darkblue,), // Add divider below the ListTile
  ],
);
