...
class CustomeCardEpisode extends StatefulWidget {
  ...
  const CustomeCardEpisode(
      ...
      this.oncardtap,
      this.cardsubtitle,
      this.youtubeicon, this.showbrief, this.episodebrief, this.guestinfo, this.credits, this.relatednews, this.photid, this.episodeid, this.videolink})
      : super(key: key);
                ...
                children: [
                  ...
                  TextSpan(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: ResponsiveFlutter.of(context).fontSize(2.1),//18
                      fontFamily: AppFonts.normal,
  ...
  SizedBox(width: 10,),
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Image.asset("assets/newImages/share.png",width: 25,height: 25,))),
  SizedBox(width: 5,),
              ],)
            ],
          ),
