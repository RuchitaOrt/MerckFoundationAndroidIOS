...
EmpoweingbernacontentResponse empoweingbernacontentResponseFromJson(String str) =>
    EmpoweingbernacontentResponse.fromJson(json.decode(str));

String empoweingbernacontentResponseToJson(EmpoweingbernacontentResponse data) =>
