...
GetAwardResponse getAwardResponseFromJson(String str) =>
    GetAwardResponse.fromJson(json.decode(str));

String getAwardResponseToJson(GetAwardResponse data) =>
  ...
  factory GetAwardResponse.fromJson(Map<String, dynamic> json) => GetAwardResponse(
        ...
        awardsList: json["awards_list"] == null
            ...
            : List<AwardsList>.from(
                json["awards_list"].map((x) => AwardsList.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "status": status,
        "message": message,
        "awards_list": awardsList?.map((x) => x.toJson()).toList(),
      };
}
