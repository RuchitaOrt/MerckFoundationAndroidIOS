  ...
  factory CancerobjectiveResponse.fromJson(Map<String, dynamic> json) =>
      CancerobjectiveResponse(
        middleArea: json["middle_area"] != null
            ...
            : MiddleArea(the1: The1(content: Content(list: [], baseUrl: ''))),
      );
...
class MiddleArea {
  ...
  factory MiddleArea.fromJson(Map<String, dynamic> json) => MiddleArea(
        the1: json["1"] != null
            ? The1.fromJson(json["1"])
            : The1(content: Content(list: [], baseUrl: '')),
      );
...
class ListElement {
  ...
  factory ListElement.fromJson(Map<String, dynamic> json) => ListElement(
        ...
        updatedAt: json["updated_at"] != null
            ? DateTime.tryParse(json["updated_at"]) ?? DateTime(1970)
            : DateTime(1970),
      );
...
// CancerobjectiveResponse cancerobjectiveResponseFromJson(String str) => CancerobjectiveResponse.fromJson(json.decode(str));

// String cancerobjectiveResponseToJson(CancerobjectiveResponse data) => json.encode(data.toJson());
...
//     factory CancerobjectiveResponse.fromJson(Map<String, dynamic> json) => CancerobjectiveResponse(
