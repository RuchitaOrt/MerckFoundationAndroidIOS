...
//
//     final educatingLindaResponse = educatingLindaResponseFromJson(jsonString);

import 'dart:convert';

EducatingLindaResponse educatingLindaResponseFromJson(String str) =>
    EducatingLindaResponse.fromJson(json.decode(str));

String educatingLindaResponseToJson(EducatingLindaResponse data) =>
    json.encode(data.toJson());

class EducatingLindaResponse {
