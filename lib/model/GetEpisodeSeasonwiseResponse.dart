...
GetEpisodeSeasonwiseResponse getEpisodeSeasonwiseResponseFromJson(String str) =>
    GetEpisodeSeasonwiseResponse.fromJson(json.decode(str));

String getEpisodeSeasonwiseResponseToJson(GetEpisodeSeasonwiseResponse data) =>
...
class GetEpisodeSeasonwiseResponse {
  ...
  factory GetEpisodeSeasonwiseResponse.fromJson(Map<String, dynamic> json) =>
      GetEpisodeSeasonwiseResponse(
