...
GetFilterDlResponse getFilterDlResponseFromJson(String str) =>
    GetFilterDlResponse.fromJson(json.decode(str));

String getFilterDlResponseToJson(GetFilterDlResponse data) =>
...
class GetFilterDlResponse {
  ...
  factory GetFilterDlResponse.fromJson(Map<String, dynamic> json) =>
      GetFilterDlResponse(
        status: json["status"],
        message: json["message"],
        digitalLibraryList: json["digital_library_list"] == null
            ? null
            : List<DigitalLibraryList>.from(json["digital_library_list"]
                .map((x) => DigitalLibraryList.fromJson(x))),
        languageList: json["language_list"] == null
            ? null
            : List<LanguageList>.from(
                json["language_list"].map((x) => LanguageList.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        "status": status,
        "message": message,
        "digital_library_list":
            digitalLibraryList?.map((x) => x.toJson()).toList(),
        "language_list": languageList?.map((x) => x.toJson()).toList(),
        "category_list": categoryList?.map((x) => x.toJson()).toList(),
      };
}
...
//         status: json["status"],
//         message: json["message"],
//         digitalLibraryList: List<DigitalLibraryList>.from(
//             json["digital_library_list"]
//                 .map((x) => DigitalLibraryList.fromJson(x))),
...
//         "message": message,
//         "digital_library_list":
//             List<dynamic>.from(digitalLibraryList.map((x) => x.toJson())),
//         "language_list":
