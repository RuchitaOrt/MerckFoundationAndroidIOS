...
GetAboutMerckContentResp getAboutMerckContentRespFromJson(String str) =>
    GetAboutMerckContentResp.fromJson(json.decode(str));

String getAboutMerckContentRespToJson(GetAboutMerckContentResp data) =>
...
class GetAboutMerckContentResp {
  ...
  factory GetAboutMerckContentResp.fromJson(Map<String, dynamic> json) =>
      GetAboutMerckContentResp(
