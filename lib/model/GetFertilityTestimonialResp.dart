...
GetFertilityTestimonialResp getFertilityTestimonialRespFromJson(String str) =>
    GetFertilityTestimonialResp.fromJson(json.decode(str));

String getFertilityTestimonialRespToJson(GetFertilityTestimonialResp data) =>
...
class GetFertilityTestimonialResp {
  ...
  factory GetFertilityTestimonialResp.fromJson(Map<String, dynamic> json) =>
      GetFertilityTestimonialResp(
