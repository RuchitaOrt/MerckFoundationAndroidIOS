...
OurpartnerobjectiveResponse ourpartnerobjectiveResponseFromJson(String str) =>
    OurpartnerobjectiveResponse.fromJson(json.decode(str));

String ourpartnerobjectiveResponseToJson(OurpartnerobjectiveResponse data) =>
...
class OurpartnerobjectiveResponse {
  ...
  factory OurpartnerobjectiveResponse.fromJson(Map<String, dynamic> json) =>
      OurpartnerobjectiveResponse(
