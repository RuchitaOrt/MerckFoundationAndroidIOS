...
MessageFromleadershipResponse messageFromleadershipResponseFromJson(String str) =>
    MessageFromleadershipResponse.fromJson(json.decode(str));

String messageFromleadershipResponseToJson(MessageFromleadershipResponse data) =>
